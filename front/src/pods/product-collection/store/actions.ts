...
import { ProductEntityVm } from "core";
...
export const fetchedProductsAction = (
  payload: ProductEntityVm[]
): BaseAction => ({
  type: actions.FETCHED_PRODUCTS,
  payload
});

export const fetchedCategoriesAction = (
  payload: CheckBoxConfigValue[]
): BaseAction => ({
...
export const handleProductTypesFilterAction = (
  name: string,
  value: boolean
): BaseAction => ({
...
export const handleChangeComfortFilterAction = (
  name: string,
  value: boolean
): BaseAction => ({
