...
import { fetchedProductsAction, fetchedCategoriesAction } from "pods/product-collection/actions";
...
export function* fetchProductsData() {
    ...
    yield put(fetchedProductsAction(mapFromAToBCollection(mapFromApiToVm, products)));
}

export function* fetchCategoriesData(){
    const suppliersLookup: CheckBoxConfigValue[] = yield call(getCategoriesCollection);
    yield put(fetchedCategoriesAction(mapFromAToBCollection(mapToCheckBoxValue, suppliersLookup)));
}
